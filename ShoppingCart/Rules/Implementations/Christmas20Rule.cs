...
{
    public class Christmas20Rule : IDiscountRule
    {
        public int Priority => DiscountPriorities.Seasonal;
        public decimal DiscountMultiplier => 0.8m;
        public bool IsMatch(CartItem item, DateTime transactionTime, bool isFirstResponder) => 
            item.Category == ProductCategories.Christmas && transactionTime.Month == 12 && transactionTime.Day < 15;
